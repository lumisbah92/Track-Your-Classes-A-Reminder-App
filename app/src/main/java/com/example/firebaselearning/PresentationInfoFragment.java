...
public class PresentationInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_presentation_info, container, false);
        ...
        postingDatabase = FirebaseDatabase.getInstance().getReference("PostInPresentationFragment");
